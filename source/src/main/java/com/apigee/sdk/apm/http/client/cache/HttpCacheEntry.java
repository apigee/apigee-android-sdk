 ...
 * optionally depend on system resources that may require explicit deallocation.
 * In such a case {@link #getResource()} should return a non-null instance of
 * {@link Resource} that must be deallocated by calling
