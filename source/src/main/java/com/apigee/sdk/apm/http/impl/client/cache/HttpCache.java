...
interface HttpCache {
	...
	/**
	 * Retrieve all variants from the cache, if there are no variants than an
	 ...
	 * @throws IOException
	 */
	Set<HttpCacheEntry> getVariantCacheEntries(HttpHost host,
	 ...
	 * @throws IOException
	 */
	HttpCacheEntry updateCacheEntry(HttpHost target, HttpRequest request,
