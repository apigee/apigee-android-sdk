...
import com.apigee.sdk.apm.android.*;
import com.apigee.sdk.apm.android.model.*;
...
public class ConfigsFragment extends Fragment implements ListViewDataSource {
    ...
    public void prepDataSource()
    {
    	...
    	if ((monitoringClient != null) && monitoringClient.isInitialized()) {
    		...
    		ApplicationConfigurationService appConfigService = monitoringClient.getApplicationConfigurationService();
    		App compositeAppConfigModel = appConfigService.getCompositeApplicationConfigurationModel();
    		ApplicationConfigurationModel appConfigModel = appConfigService.getConfigurations();
    ...
    public HashMap<String,String> loadDeviceInfo()
    {
    	...
    	info.put(keyApigeeDeviceId, MA.getApigeeDeviceId());
        return info;
    }
    ...
    public HashMap<String,String> loadAppInfoFromSettings(App model)
    {
    	if( model != null )
    	{
    		HashMap<String,String> info = new HashMap<String,String>();
    ...
    public HashMap<String,String> loadConfigFromSettings(ApplicationConfigurationModel model)
    {
    ...
    public HashMap<String,String> loadConfigParams(ApplicationConfigurationModel model)
    {
    	int numberParams = 0;
