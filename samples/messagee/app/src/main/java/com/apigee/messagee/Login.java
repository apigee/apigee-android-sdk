...
public class Login extends ApigeeActivity implements View.OnClickListener{
	...
	public void onClick(View arg0){
		...
		case R.id.server_button_id:
			...
			i.setClassName("com.apigee.messagee",
					"com.apigee.messagee.ChangeServerURLDialog");
			startActivity(i);
			break;
		...
		case R.id.register_button_id:
			...
			i2.setClassName("com.apigee.messagee",
					"com.apigee.messagee.AddAccount");
			startActivity(i2);
			break;
		}
	}
