...
public class MonitoringSampleActivity extends Activity implements NetworkResponseListener {
    ...
    private static final String ORG_NAME = "<YOUR ORG NAME>";
    private static final String APP_NAME = "sandbox"; // or <YOUR APP NAME>
	...
	public void monitoringPauseCheckBoxToggled() {
        ...
        ApigeeMonitoringClient monitorClient = null;
